...
See [here](https://godbolt.org/z/jfn5rM6vd) for a complete working example (demo for those who want to get right to the code - the same code in this repository).
